						...
						<div class="widget widget-table action-table">
							...
							<div class="widget-content">
								...
								<form id="register-company" class="form-horizontal"
									...
									<fieldset>
										<label class="control-label" for="phone_details">Username</label>
										<div class="controls">
											<input type="text" class="span2" id="phone_code"
												name="phone_code">&nbsp;&nbsp;<button type="submit" class="btn btn-primary btn-mini">
								...
								<table class="table table-striped table-bordered">
									...
									<tbody>
										...
										<tr>
											<td><%=++recordCount%></td>
											<td><a
												href="user_details.vw?user_id=<%=user.getId()%>">
													<%=user.getUserName()%> </a></td>
                                            <td><%=user.getEmail() %></td>
											<td><%=user.getLastLogin() %></td>
											<td><%=user.getStatus() %></td>
											<td><a
												href="edit_user.vw?user_id=<%=user.getId()%>"
